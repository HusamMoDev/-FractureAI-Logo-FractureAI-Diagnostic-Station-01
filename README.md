...
> **توضيح هام:** رخصة MIT هذه تنطبق حصرياً على الكود المصدري الموجود داخل مجلد `frontend/`. أما الأكواد والمنهجيات الموجودة في مجلد `ai_model/` فهي محفوظة الحقوق بالكامل (All Rights Reserved) لأغراض البحث العلمي ولا تخضع لهذا الترخيص.
